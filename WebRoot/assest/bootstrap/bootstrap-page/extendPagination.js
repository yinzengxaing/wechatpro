        ...
        if (totalPage > 0) {
            ...
            if (totalPage <= showPage) {
                for (var i = 1; i <= totalPage; i++) {
                    if (i == 1) html.push(' <li class="clickItem active"><a href="#">' + i + '</a></li>');
                    else html.push(' <li class="clickItem"><a href="#">' + i + '</a></li>');
                }
            } else {
                for (var j = 1; j <= showPage; j++) {
                    if (j == 1) html.push(' <li class="clickItem active"><a href="#">' + j + '</a></li>');
                    else html.push(' <li class="clickItem"><a href="#">' + j + '</a></li>');
                }
            }
            html.push('<li class="disabled hidden"><a href="#">...</a></li>');
            ...
            currentObj.click(function (event) {
                ...
                var currPage = Number($(this).find('a').html()), activeObj = pageObj.find('li[class="clickItem active"]'),
            ...
            nextObj.click(function (event) {
                event.preventDefault();
                var activeObj = pageObj.find('li[class="clickItem active"]'), activePage = Number(activeObj.find('a').html());
