...
$(function(e){
	...
	phoneNavigateDataInit();
});

function phoneNavigateDataInit(){
	$("#navigate").load("common/navigate.html",function(e){
		phoneNavigateEventInit();
	});
}

function phoneNavigateEventInit(){
	$('body').on('click', '.dropIco', function(e){
		if(isNull($(this).attr("rowHref"))){
			qiao.bs.msg({msg:"该功能正在努力开发中，请等待",type:'danger'});
		}else{
