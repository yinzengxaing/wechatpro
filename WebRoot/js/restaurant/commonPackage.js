...
function eventTini(){
	...
	$("body").on("click", '#selectBtn', function(e){
		$('#message').bootstrapTable('refresh', {url: path+'/post/wechatCanteenProductManageController/selectPackageProductByChoose'});
	});
...
var TableInit =  function (){
	...
	oTableInit.Init = function(){
		$("#message").bootstrapTable({
			url: path+'/post/wechatCanteenProductManageController/selectPackageProductByChoose', // 请求后套的URL
			method:"post", 						// 请求方式（*）
